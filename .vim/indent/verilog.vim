...
if exists("b:_LEX_LEONARD__verilogIndentExists")
   "  finish
endif
let b:_LEX_LEONARD__verilogIndentExists = 1
...
function! GetVerilogIndent()
   ...
   if exists('b:verilog_indent_verbose')
      let _LEX_LEONARD__vverb = 1
   else
      let _LEX_LEONARD__vverb = 0
   endif
   let _LEX_LEONARD__vverb_str = 'INDENT VERBOSE:'
   ...
   if last_line =~ prefix . section_open . postfix
      ...
      if last_line !~ prefix . section_open . anything . section_close . postfix
         let ind = ind + offset
         if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "Indent after section statement." | endif
      else
         if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "Do not indent after this section statement." | endif
      endif
   ...
   elseif last_line =~ prefix . block_open . postfix
      ...
      if last_line !~ prefix . 'begin' . anything . 'end' . postfix &&
         ...
         if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "Do not indent after this block statement." | endif
      endif
   ...
   elseif last_line =~ prefix . 'begin' . postfix
      ...
      if last_line !~ prefix . 'begin' . anything . 'end' . postfix
         let ind = ind + offset
         if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "Indent after a begin statement." | endif
      else
         if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "Do not indent after this begin statement." | endif
      endif
   ...
   elseif last_line =~ prefix . 'for' . postfix
      ...
      if last_line !~ ').*;' && curr_line !~ line_start . 'begin\s*$'
         ...
         if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "Do not indent after this for statement." | endif
      endif
   ...
   elseif last_line =~ list_open
      ...
      if last_line !~ list_open . '.*' . list_close
         let ind = ind + offset
         if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "Indent after a list opener." | endif
      else
         if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "No indent since list was closed immediately." | endif
      endif

   else
      if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "Nothing to do" | endif
   ...
   if last_line2 =~ prefix . 'begin' . postfix
      if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "Begin blocks one-line block de-indenting" | endif
   ...
   elseif last_line2 =~ prefix . block_open . postfix
      ...
      if last_line2 !~ ';'
         let ind = ind - offset
         if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "De-indent after the end of one-line statement." | endif
      else
         if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "Do not de-indent after this one-line statement." | endif
      endif
   ...
   elseif last_line2 =~ line_start . 'for' . postfix
      ...
      if last_line2 !~ ').*;'
         let ind = ind - offset
         if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "De-indent after the end of one-line for loop." | endif
      else
         if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "Do not indent after this one-line for loop." | endif
      endif
   ...
   elseif (last_line2 =~ list_continue . '\s*$' || last_line2 =~ list_open . '\s*$') &&
      ...
      let ind = ind - offset
      if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "De-indent after a quick closing list." | endif
   endif
   ...
   if curr_line =~ prefix . 'end' . postfix
      ...
      if curr_line !~ prefix . 'begin' . anything . 'end' . postfix
         ...
         if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "Do not de-indent the end of this block." | endif
      endif
   ...
   elseif curr_line =~ prefix . section_close . postfix
      ...
      if curr_line !~ prefix . section_open . anything . section_close . postfix
         ...
         if _LEX_LEONARD__vverb | echo _LEX_LEONARD__vverb_str "Do not de-indent the end of this section." | endif
      endif
