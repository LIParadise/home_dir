...
alias mv="mv -i"
alias nv="nvim"
alias nvc="nvim --clean -R +'set nu ai ic sc et sts=4 ts=4 hlsearch paste | colorscheme peachpuff | let mapleader = \" \" | nnoremap <leader>n :noh<CR> | nnoremap <leader>w :w<CR>'"
alias nvv="nvim -R"
