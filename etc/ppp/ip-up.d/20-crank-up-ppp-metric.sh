...
fn_dhcp_in_default_route(){
        ip route | grep default | grep -c dhcp
}
fn_default_route_settings(){
...
dhcp_in_default_route=$(fn_dhcp_in_default_route)
vpn_default_route_settings=$(fn_default_route_settings vpn)
dhcp_default_route_settings=$(fn_default_route_settings dhcp)
